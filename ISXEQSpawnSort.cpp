...
#include "ISXEQSpawnSort.h"

// The mandatory pre-setup function.  Our name is "ISXEQSpawnSort", and the class is ISXEQSpawnSort.
...
// our instanced class.
ISXPreSetup("ISXEQSpawnSort", ISXEQSpawnSort);
...
unsigned int ISXEQSpawnSortXML = 0;
...
bool ISXEQSpawnSort::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQSpawnSort Loaded");
	return true;
}

// shutdown sequence
void ISXEQSpawnSort::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQSpawnSortXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQSpawnSortXML);
...
void ISXEQSpawnSort::ConnectServices()
{
...
void ISXEQSpawnSort::RegisterCommands()
{
	// add any commands
...
void ISXEQSpawnSort::RegisterAliases()
{
	// add any aliases
}

void ISXEQSpawnSort::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQSpawnSort::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQSpawnSort::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQSpawnSort::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQSpawnSort::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQSpawnSort::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQSpawnSortService)
	//        pISInterface->ShutdownService(this,hISXEQSpawnSortService);
}

void ISXEQSpawnSort::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQSpawnSortXML
	ISXEQSpawnSortXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQSpawnSortXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQSpawnSortXML, "General"))
	{
